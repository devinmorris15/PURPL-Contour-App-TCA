...
def run(mode, mat, chamber_geom, throat_geom, cea_cfg, solv_cfg, env_cfg, output_path="thermal_output.gif"):
    ...
    render_gif(results, output_path, is_combined=is_combined)
